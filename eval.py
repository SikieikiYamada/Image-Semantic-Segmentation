...
if __name__ == '__main__':
    ...
    # e.g., Dataset_Seg(r'path to your prediction results', r'path to the groundtruths', split='/data/workspace/val')
    # (assume you have a '/data/workspace/val.txt')
    loader = Dataset_Seg(r'./val_res/', r'./annotations_trainval/', split='temp').get_loader()
    evaluate(loader, 21)
